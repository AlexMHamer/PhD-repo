...
imagery = '' # 3-band images (NIR, R, G)
labels = '' # Reference agricultural mask with two classes. Class 0: Non-agriculture and 1: agriculture
binary_masks = '' # Input with two classes. Class 0: Non-agriculture and agriculture from previous years and 1: New agricultural areas used for training
...
weighted_labels = train_labels_raw * binary_masks # Only considers new agricultural areas during training
train_labels = keras.utils.np_utils.to_categorical(weighted_labels)
